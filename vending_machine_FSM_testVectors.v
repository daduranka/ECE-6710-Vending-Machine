...
//          food_dispensed - 1'b; amount_left - 10'b;  
//Outputs: num_to_display - 10'b; food_selection - 5'b; amount_to_return - 10'b; 
//format: reset(x), SUM(xxxxxxxxxx), A(x), B(x), C(x), D(x), ONE(x), TWO(x), THREE(x), FOUR(x), FIVE(x), food_dispensed(x), amount_left (xxxxxxxxxx) 
...
1_0000000000_0_0_0_0_0_0_0_0_0_0_xxxxxxxxxx_0000000001_00000_0000000001  //returning the one cent
0_0000000000_0_0_0_0_0_0_0_0_0_0_xxxxxxxxxx_0000000000_00000_0000000000  //resetting when change returned = True
...
0_0001110011_0_0_0_0_0_0_0_0_0_0_xxxxxxxxxx_0001110011_00000_0000000000   //inserting $1.15
